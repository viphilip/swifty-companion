...
Ethereal depth through layered translucent surfaces. Bright, airy, and premium.
 
## Colors
- **Primary (`#7dd3fc`):** Ice-blue for interactive elements and accents.
- **Background (`#e0eaf2`):** Light, almost white, base for a frosted glass effect.
- **Secondary (`#88b4cc`):** A supporting blue-grey, for less prominent UI elements, chips, and secondary actions.
- **Tertiary (`#c8a0f0`):** Soft lavender for highlights, badges, or decorative elements.
- All surface containers should feel like tinted glass layers.
 
## Glass Effect (Core Pattern)
- **Cards/Panels:** `background: rgba(255, 255, 255, 0.6)`, `backdrop-filter: blur(16px)`, `border: 1px solid rgba(125, 211, 252, 0.1)`.
